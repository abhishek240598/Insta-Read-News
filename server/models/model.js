...
var Notinterested = mongoose.Schema({
    hash: {
        type: String,
        required: true,
        index: true,
...
var Readhistory = mongoose.Schema({
    hash: {
        type: String,
        required: true,
        index: true,
...
module.exports = {
    ...
    Notinterested: mongoose.model('Notinterested', Notinterested),
    ReadingList: mongoose.model('ReadingList', ReadingList),
    Readhistory: mongoose.model('Readhistory', Readhistory),
    Recommendations: mongoose.model('Recommendations', Recommendations),
